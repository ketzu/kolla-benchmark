...
class ModelInfoTests(unittest.TestCase):
    def test_names_the_provider_after_the_endpoint(self):
        ...
        self.assertEqual(model_info.provider("http://localhost:1234/v1"), "Local")
        self.assertEqual(model_info.provider("http://vast.local:8000/v1"), "Vast.ai")
        self.assertEqual(model_info.provider("http://gpu-box:8000/v1"), "gpu-box")
